    ...
    <section className="pt-32 max-w-7xl mx-auto px-6 py-12 flex flex-col lg:flex-row items-center gap-16 hero-gradient">
      <div className="flex-1 space-y-8 text-center lg:text-left">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
          <a href="https://mercado-lovable3.vercel.app/login" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-10 py-5 bg-primary hover:bg-primary-dark text-white text-lg font-black rounded-2xl transition-all shadow-2xl shadow-primary/30 transform hover:-translate-y-1 text-center">
