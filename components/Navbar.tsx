    ...
    <header className="fixed top-0 w-full z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-800/50">
      <nav className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <a className="hidden sm:block text-sm font-bold text-slate-700 dark:text-slate-300 hover:text-primary" href="https://mercardoproo.vercel.app/login" target="_blank" rel="noopener noreferrer">Entrar</a>
          <a className="bg-primary hover:bg-primary-dark text-white px-6 py-3 rounded-xl text-sm font-extrabold transition-all shadow-lg shadow-primary/20" href="https://mercardoproo.vercel.app/login" target="_blank" rel="noopener noreferrer">
            Começar agora mesmo
          </a>
        </div>
      </nav>
